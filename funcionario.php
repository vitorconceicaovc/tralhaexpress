...
<body>
    ...
    function atualizar() {
        ...
        email_funcionario='$email',contacto_funcionario='$contacto'
    ...
    $sql="SELECT * FROM funcionarios WHERE id_funcionario='$cliente'";
        ...
        <section id="perfil" class="cliente">
            <div class="navbar">
                ...
                <div class="links">
                    ...
                    <a onclick="servicos()" href="agendamentos_funcionario.php?id='.$cliente.'">Agendamentos</a>
            ...
            <div class="profile-area">
                ...
                <img src="'.$linha['foto_funcionario'].'" alt="">
    
                <form action="funcionario.php?id='.$cliente.'" method="post">
                    <p></p>
                    <div class="roud">
                        <input type="file" name="">
                        <i class="fas fa-upload"></i>
                    </div>
                    <input class="blocked" type="text" name="nome" placeholder="Nome" value="'.$linha['nome_funcionario'].'" readonly>
                    <input type="text" name="contacto" placeholder="Contacto" value="'.$linha['contacto_funcionario'].'" required>
                    <input type="text" name="email" placeholder="Email" value="'.$linha['email_funcionario'].'" required>
